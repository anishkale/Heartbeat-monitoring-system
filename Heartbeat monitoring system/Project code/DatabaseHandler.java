...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    String getregister2(String pass2){
        SQLiteDatabase db = this.getReadableDatabase();
        //String selectquery="SELECT * FROM TABLE_REGISTER";
        Cursor cursor=db.query(TABLE_REGISTER, null, "email_id=?", new String[]{pass2}, null, null, null, null);
    ...
    String getregister3(String pass){
        SQLiteDatabase db = this.getReadableDatabase();
        //String selectquery="SELECT * FROM TABLE_REGISTER";
        Cursor cursor=db.query(TABLE_REGISTER, null, "email_id=?", new String[]{pass}, null, null, null, null);
